		...
		<div class="row">
			...
			<div class="col-md-4">
				<div>
					<div>
								<%
									if (request.getAttribute("forgot") == "true") {
								%>
								
									<div class="alert alert-success" role="alert">Password is updated
									</div>
								<%
									}else if(request.getAttribute("forgot") == "false"){
								%>
									
									<div class="alert alert-danger" role="alert">Cant update password beacause Email or
									Secret answer is incorrect!</div>
								<%
									}
								%>
			...
			<div class="col-md-7">
				<div>
					...
					<div style="width: 80%; margin-top: 50px;">
						...
						<%
							if (request.getAttribute("sameUser")=="true") {
						%>
						<div class="alert alert-danger" role="alert">This USER NAME is used. So try different USER NAME
							</div>
						<%
							}
						%>
						...
						style="width: 100%; margin-top: 50px; padding: 20px 50px 50px 50px">
						<div align="center">
						<h2>Supplier Registraion Portal</h2>
			...
			<div class="modal-content">
				...
				<div class="form-group">
					<label for="contact"><span style="color: navy;">New
							password</span></label> <input type="password" class="form-control" id="password"
						name="password" required="required">
				</div>
				<div class="form-group">
					<label for="contact"><span style="color: navy;">Confirm
							new password</span></label> <input type="password" class="form-control"
						id="conanswer" name="conanswer" required="required">
				</div>
				<div class="registrationFormAlert" style="color: red;"
								id="CheckPasswordMatch2"></div>
				
				<div align="center">
					<button type="submit" class="btn btn-primary" style="width: 50%"
						id="btn3" name="btn" value="btn3">Change Password</button>
				</div>
			</div>
...
<script>
	function checkPasswordMatch2() {
		...
		var confirmPassword = $("#conanswer").val();
		if (password != confirmPassword) {
			$("#CheckPasswordMatch2").html("Passwords does not match!");
	...
	$(document).ready(function() {
		$("#conanswer").keyup(checkPasswordMatch2);
	});
</script>
