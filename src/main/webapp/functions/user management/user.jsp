...
<body> 
		  ...
		  <c:forEach var="uDetails" items="${userDetails}">
           <button type="button" class="btn btn-warning"   onclick="location.href='../user%20management/add_delivery_notes.jsp?userId=${uDetails.user_name}'" 	>Add delivery notes</button>
      		</c:forEach>
      </div>
	    &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;  
	    &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;  <button type="button" class="col-15 col-sm-1 d-flex align-items-center justify-content-center home-btn-parent" onclick="location.href='../user%20management/login.jsp'" >Log Out</button>
