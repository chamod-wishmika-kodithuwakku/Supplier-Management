		...
		<div class="row inventory-dash">
			...
			<div class="col-12 col-sm-12 col-md-10">
				<div class="dashboard-body-title">
					Search Supplier by User Name /Supplier First name or Supplier Email
				</div>
		...
		<div class="row">
			<table class="table">
				<thead class="thead-dark">
					<tr>
						<th scope="col">ID</th>
						<th scope="col">Supplier's First Name</th>
						<th scope="col">Supplier's Name</th>
						<th scope="col">Supplier's Email</th>
						<th scope="col">Supplier's Address</th>
						<th scope="col">Supplier's City</th>
						<th scope="col">Supplier's Phone Number</th>
					</tr>
				</thead>
